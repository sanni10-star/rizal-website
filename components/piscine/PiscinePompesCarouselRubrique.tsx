...
import { PISCINE_MARQUES_POMPES_PATH } from "@/content/piscine-marques-pompes";
import { piscinePompeMarques } from "@/content/piscine-pompes-marques";
import { cn } from "@/lib/utils";

const aspectClass =
  "aspect-[16/9] min-h-[17.5rem] sm:aspect-[21/9] sm:min-h-[min(42vw,22rem)] md:min-h-[min(38vw,26rem)]";

export function PiscinePompesCarouselRubrique() {
  ...
  const active = piscinePompeMarques[selected];
  ...
  return (
    <div className="mt-10">
      ...
      >
        <div ref={emblaRef} className="h-full overflow-hidden">
          <div className="flex h-full">
            {piscinePompeMarques.map((marque, index) => {
              ...
              return (
                ...
                >
                  <Link
                    href={`${PISCINE_MARQUES_POMPES_PATH}#${marque.id}`}
      ...
      {active ? (
        <Link
          href={PISCINE_MARQUES_POMPES_PATH}
