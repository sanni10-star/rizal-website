...
import type { PiscineCouvertureProduct } from "@/content/piscine-marques-couverture";

export function PiscineCouvertureProductCard({
  product,
  sectionTitle,
  accent,
  whatsappHref,
}: {
  product: PiscineCouvertureProduct;
  sectionTitle: string;
  accent: string;
  whatsappHref: string;
}) {
