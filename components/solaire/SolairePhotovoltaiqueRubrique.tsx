...
import { SOLAIRE_MARQUES_PHOTOVOLTAIQUE_PATH } from "@/content/solaire-marques-photovoltaique";
...
export function SolairePhotovoltaiqueRubrique() {
  ...
  const active = solairePhotovoltaiqueMarques[selected];
  ...
  return (
    <div className="mt-10">
      ...
      >
        <div ref={emblaRef} className="h-full overflow-hidden">
          <div className="flex h-full">
            {solairePhotovoltaiqueMarques.map((marque, index) => {
              ...
              return (
                ...
                >
                  <Link
                    href={`${SOLAIRE_MARQUES_PHOTOVOLTAIQUE_PATH}#${marque.id}`}
        ...
        <div className="absolute bottom-4 left-1/2 z-20 flex -translate-x-1/2 gap-1.5">
          {solairePhotovoltaiqueMarques.map((m, i) => (
            <button
              key={m.id}
              type="button"
      ...
      {active ? (
        <Link
          href={SOLAIRE_MARQUES_PHOTOVOLTAIQUE_PATH}
        ...
        >
          <div className="max-w-2xl">
            <p className="mb-1.5 text-[11px] font-semibold uppercase tracking-brand text-sand-600">
              Panneaux photovoltaïques Tier 1
            </p>
