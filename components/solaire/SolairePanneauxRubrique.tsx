...
import { solairePanneauxRubriqueTiles } from "@/content/solaire-panneaux-rubrique";
...
export function SolairePanneauxRubrique() {
  return (
    <div className="mt-10">
      {solairePanneauxRubriqueTiles.map((tile) => (
        <Link key={tile.id} href={tile.href} className="group block outline-none">
          {/* ── Image pure, plein cadre ── */}
          <div
            className={cn(
