...
import { solaireBatteriesRubriqueTiles } from "@/content/solaire-batteries-rubrique";
...
export function SolaireBatteriesRubrique() {
  return (
    <div className="mt-10">
      {solaireBatteriesRubriqueTiles.map((tile) => (
