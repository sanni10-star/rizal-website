...
export const heroSlides: HeroSlide[] = [
  {
    ...
    titleFr: "Climatiseur & Quincaillerie à Essaouira.",
    subtitleFr:
      "MEGALIFE · INGELEC · LG · TRANE — vente et installation de climatiseur à Essaouira, garantie constructeur.",
  ...
  },
  {
    ...
    titleFr: "Droguerie & Hardware Store à Essaouira.",
    subtitleFr:
      "Plomberie, électricité, droguerie, climatisation, piscine et panneau solaire — votre magasin RIZAL à Essaouira.",
  ...
  },
  {
    ...
    titleFr: "Panneau Solaire à Essaouira.",
    subtitleFr:
      "Panneaux Tier 1, onduleurs hybrides, batteries lithium — kits photovoltaïques installés à Essaouira et région.",
